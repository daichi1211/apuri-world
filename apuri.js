...
if(a==0){
  ...
  document.getElementById("input-send-to").style.display="none"
  document.getElementById("input-user-neme").style.display="none"
  document.getElementById("input-user-email").style.display="none"
  document.getElementById("input-message").style.display="none"
  $("#saveBtn").html("編集");}
else if(a==1){
  memo.style.display = "block"
  document.getElementById("input-send-to").style.display="block"
  document.getElementById("input-user-naeme").style.display="block"
  document.getElementById("input-user-email").style.display="block"
...
if (saveBtn) {
    saveBtn.addEventListener("click", () => {
        if (a == 0) {
            ...
            memo.style.display = "block";
            document.getElementById("input-send-to").style.display="block"
            document.getElementById("input-user-neme").style.display="block"
            document.getElementById("input-user-email").style.display="block"
            document.getElementById("input-message").style.display="block"
            $("#saveBtn").html("保存");
            a = 1;
            ...
            localStorage.setItem("user-neme", userName.value);
            ...
            memo.style.display = "none";
            document.getElementById("input-send-to").style.display="none"
            document.getElementById("input-user-name").style.display="none"
            document.getElementById("input-user-email").style.display="none"
            document.getElementById("input-message").style.display="none"
            $("#saveBtn").html("編集");
            a = 0;
